        ...
        <div className="dark:text-white">
            <div className={`flex flex-row justify-center items-center border-2 ${searchValue ? "bg-red-300 dark:bg-red-700" : "bg-black"} border-gray-400 rounded-full transition-all duration-200`}>
                ...
                />
                    <Link
                        type="button"
                        className={`${searchValue ? "translate-x-0 opacity-100 bg-red-300 dark:bg-red-700 hover:px-5" : "-translate-x-6 opacity-0 cursor-default"} px-4 py-2 rounded-e-full z-0 transition-all duration-200 outline-none`}
